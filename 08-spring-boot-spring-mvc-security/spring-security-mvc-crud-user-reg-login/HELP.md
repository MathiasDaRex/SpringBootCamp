...
* The original package name 'com.mathiasdarex.spring-security-mvc-crud-user-reg-login' is invalid and this project uses 'com.mathiasdarex.spring_security_mvc_crud_user_reg_login' instead.
